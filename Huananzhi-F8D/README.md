...
## ![#f03c15](https://via.placeholder.com/15/f03c15/000000?text=+) `Версия для macOS 10.14 (Mojave)`
Вы находитесь в бранче `macOS 10.14 (Mojave)`. Последние версии сборки доступны только в основном бранче данного репозитория.
