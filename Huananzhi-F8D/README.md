# Huananzhi F8D
**([русская версия](https://github.com/tarkh/hackintosh/blob/macOS-11-(Big-Sur)/Huananzhi-F8D/README-rus.md))**

## ![#f03c15](https://via.placeholder.com/15/f03c15/000000?text=+) `Version for macOS 11 (Big Sur)`
*You are in the macOS 11 (Big Sur) branch. The latest build versions are available only in the main branch of this repository.*
