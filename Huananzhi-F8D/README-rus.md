...
## <img src="https://via.placeholder.com/12/f03c15/f03c15.png"> `Версия для macOS 12 (Monterey)`
*Вы находитесь в бранче macOS 12 (Monterey). Последние версии сборки доступны только в основном бранче данного репозитория.*
...
* Сгенерировать и добавить свои уникальные серийные номера для модели **iMac17,1**. Вам понадобится утилита [GenSMBIOS](https://github.com/corpnewt/GenSMBIOS). Полученные UUID и серийники нужно заменить в файле `EFI/OC/config.plist` в следующих ключах:
...
<table width="100%">
  <tr>
    <td align="center" valign="top" colspan="2">
      XcodeBenchmark (<a href="https://github.com/devMEremenko/XcodeBenchmark#xcode-130-or-above">сравнить с результатами Mac</a>)<br>
